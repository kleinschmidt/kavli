...
* Even if we don't know exactly the means and variances, we still want to be able
...
\begin{align}
  ...
  & \frac{p(x | \mu_b, \sigma^2_p) p(c=b)}{p(x | \mu_b, \sigma^2_p) p(c=b) + p(x | \mu_p, \sigma^2_p) p(c=p)} \\ 
