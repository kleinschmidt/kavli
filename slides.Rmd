...
```{r model-fits, fig.width=8, fig.height=2}
...
block10_class_summary %>%
  ...
  geom_line() +
  geom_pointrange(data=block910_dat, aes(x = vot, y=resp_p), stat='summary', fun.data='mean_cl_boot') +
